...
{		
	...
	ST7789_WriteSmallData(x_start);//Lcd_WriteData(x_start+2);
	ST7789_WriteSmallData(0x00);
	ST7789_WriteSmallData(x_end+2);

	ST7789_WriteCommand(0x2b);
	ST7789_WriteSmallData(0x00);
	ST7789_WriteSmallData(y_start+0);
	ST7789_WriteSmallData(0x00);
	ST7789_WriteSmallData(y_end+1);
...
void ST7789_DrawImage(uint16_t x,uint16_t y,uint16_t length,uint16_t width,const uint16_t pic[])
{
	uint16_t i,j;
    uint32_t k=0;
...
void ST7789_Test(void)
{
	...
	ST7789_DrawImage(0, 0, 100, 100, (uint16_t *)saber);
